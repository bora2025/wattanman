...
export default function CardDesignerNewPage() {
      ...
      <div className="page-shell">
        ...
        <div className="page-content lg:ml-0 flex flex-col">
          ...
          <div className="px-6 py-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 flex items-center gap-3 shrink-0">
            ...
            <span className="text-xs text-slate-400 dark:text-slate-500">/</span>
            <span className="text-xs font-semibold text-slate-700 dark:text-slate-200">New Blank / Certificate</span>
          </div>
          <div className="flex-1 overflow-hidden">
            <CardEditor openNewProject={true} />
          </div>
        </div>
      </div>
    </AuthGuard>
