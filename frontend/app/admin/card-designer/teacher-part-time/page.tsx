      ...
      <div className="page-shell">
        ...
        <div className="page-content lg:ml-0 flex flex-col">
          ...
          <div className="px-6 py-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 flex items-center gap-3 shrink-0">
            ...
            <span className="text-xs text-slate-400 dark:text-slate-500">/</span>
            <span className="text-xs font-semibold text-orange-700 dark:text-orange-300 inline-flex items-center gap-1">
              <span>⏰</span> TPT ID Card Workspace
            </span>
            <span className="ml-2 text-[10px] text-slate-400 dark:text-slate-500 hidden sm:inline">• Part-time teacher designs only</span>
          </div>
