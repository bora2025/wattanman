  ...
  return (
    <AuthGuard allowedRoles={['ADMIN']}>
      ...
      <style jsx global>{`
        ...
        @import url('https://fonts.googleapis.com/css2?family=Noto+Sans+Khmer:wght@400;500;600;700&family=Hanuman:wght@400;700&display=swap');
        @media print {
          .print\\:hidden { display: none !important; }
          .print\\:bg-white { background: white !important; }
          .print-page { page-break-after: always; }
          .print-page:last-child { page-break-after: avoid; }
          body { margin: 0; font-family: 'Noto Sans Khmer', 'Hanuman', sans-serif; }
          .print-page, .print-page * { font-family: 'Noto Sans Khmer', 'Hanuman', sans-serif !important; }
        }
      `}</style>
    </AuthGuard>
  )
  ...
  return (
    <>
      {classesToPrint.map((cls, clsIdx) => (
        <div key={cls.id} className="print-page" style={{ padding: '20px 24px', fontFamily: "'Noto Sans Khmer', 'Hanuman', sans-serif" }}>
          {/* Header */}
