    ...
    <AuthGuard allowedRoles={['ADMIN']}>
            ...
            {loading ? (
              ...
              <div className="overflow-auto rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900">
                <table className="text-xs border-collapse">
                  ...
                  <tbody>
                    {teachers.map(t => (
                      <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-slate-800 even:bg-gray-50/30">
                        <td className="border border-gray-200 dark:border-slate-700 px-3 py-2 font-medium sticky left-0 bg-white dark:bg-slate-900">
                        ...
                        {dates.flatMap(d =>
                          periodArr.map(p => {
                            ...
                            return (
                              <td key={`${d}_${p}`} className="border border-gray-200 dark:border-slate-700 px-1 py-1 text-center">
                ...
                {/* Legend */}
                <div className="px-4 py-2 border-t border-gray-100 dark:border-slate-800 flex gap-4 text-xs text-gray-500 dark:text-slate-400">
                  <span><span className="font-semibold text-emerald-600 dark:text-emerald-400">P</span> = Present</span>
                  <span><span className="font-semibold text-amber-600 dark:text-amber-400">L</span> = Late</span>
                  <span><span className="font-semibold text-red-600 dark:text-red-400">A</span> = Absent</span>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-md">
            <div className="px-5 py-4 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
              <h2 className="font-bold text-gray-800 dark:text-slate-100">Manual Attendance Mark</h2>
      ...
      {showQrModal && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-md">
            <div className="px-5 py-4 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
              <h2 className="font-bold text-gray-800 dark:text-slate-100">Scan Teacher QR Code</h2>
            ...
            <div className="px-5 py-3 border-t border-gray-200 dark:border-slate-700 flex justify-end gap-2">
              <button onClick={() => { setShowQrModal(false); setScanResult(null); setQrInput('') }}
                className="px-4 py-2 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-200 rounded-lg text-sm font-medium">Close</button>
