    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-800">
            ...
            <div className="px-4 sm:px-6 py-3 sm:py-5 flex flex-col items-center">
              ...
              <div className="w-full space-y-2">
                <div className="flex items-center gap-3 py-3 px-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                  <div className="w-9 h-9 rounded-lg bg-emerald-100 dark:bg-emerald-950/40 flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-sm">🏫</div>
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-30">
        <div className="max-w-5xl mx-auto px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          ...
          <Link href="/teacher" className="shrink-0 text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
            ← Back
          </Link>
        </div>
        ...
        {teacherClasses.length > 0 && (
          <div className="card p-3 sm:p-4">
            ...
            <select
              ...
              className="w-full sm:w-auto rounded-xl border border-slate-300 dark:border-slate-600 px-3 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none bg-white dark:bg-slate-900"
            >
        ...
        {scheduledDayOff && (
          <div className="px-4 py-3 rounded-xl text-sm font-medium shadow-sm bg-red-50 dark:bg-red-950/40 text-red-800 dark:text-red-300 border border-red-200 dark:border-red-900 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span>Today is a <strong>scheduled day-off</strong> for this class. All students are auto-marked as PERMISSION. Contact admin to update the class schedule if this is incorrect.</span>
            </div>
          </div>
        )}
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-5 h-5 text-emerald-600 dark:text-emerald-400 rounded border-slate-300 dark:border-slate-600 focus:ring-emerald-500"
                      />
          ...
          {students.length === 0 && (
            <div className="card p-12">
              <div className="empty-state">
                ...
                <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Make sure a class is selected with students enrolled.</p>
              </div>
            </div>
          )}
        </div>
