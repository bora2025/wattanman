...
export const adminNav: NavItem[] = [
  ...
  {
    label: "nav.studyYears",
    href: "/admin/study-years",
    icon: "layers",
    moduleKey: "CLASSES",
  },
  {
  ...
  {
    label: "nav.takeAttendance",
    href: "/admin/camera",
    icon: "camera",
    section: "nav.section.attendance",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.editAttendance",
    href: "/admin/attendance/edit",
    icon: "edit",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.officerAttendance",
    href: "/admin/staff-attendance",
    icon: "clipboard",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.editOfficerAttendance",
    href: "/admin/staff-attendance/edit",
    icon: "edit",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.studentReport",
    href: "/admin/reports",
    icon: "chart",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.officerReport",
    href: "/admin/staff-reports",
    icon: "bar-chart",
    moduleKey: "ATTENDANCE",
  },
  {
    label: "nav.sessionSettings",
  ...
  { label: "nav.manageOfficer", href: "/admin/employees", icon: "briefcase" },
  {
    ...
    href: "/wattaman/scheduled-teacher",
    icon: "graduation",
    moduleKey: "PART_TIME_TEACHER",
  },
  {
    label: "nav.teacherReports",
  ...
  },
  {
    ...
    href: "/admin/class-registrations",
    icon: "clipboard",
    badgeKey: "class-registrations" as const,
  },
  ...
  // ── Designer ──
  {
    label: "nav.cardDesigner",
    href: "/admin/card-designer",
    icon: "design",
    section: "Designer",
    moduleKey: "CARD_DESIGNER",
  },
  {
    label: "nav.studentCards",
    href: "/admin/student-cards",
    icon: "id-card",
    moduleKey: "CARD_DESIGNER",
  },
  {
    label: "nav.staffCards",
    href: "/admin/staff-cards",
    icon: "id-card",
    moduleKey: "CARD_DESIGNER",
  },
  {
