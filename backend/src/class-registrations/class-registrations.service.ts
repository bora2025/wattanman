...
export class ClassRegistrationsService {
  ...
  async updateSettings(body: { khmerNameMode?: string; phoneMode?: string; emailMode?: string; photoMode?: string; passwordMode?: string }) {
    const data: Record<string, string> = {};
    for (const key of ['khmerNameMode', 'phoneMode', 'emailMode', 'photoMode', 'passwordMode'] as const) {
      const v = body?.[key];
